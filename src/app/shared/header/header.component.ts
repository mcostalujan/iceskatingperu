...
export class HeaderComponent {
  ...
  ngOnInit(): void {
    ...
    this.country = [
      ...
      {
        label: 'Deutsche',
        value: 'assets/images/flags/germany.svg',
        code: 'gr',
      },
  ...
  windowScroll() {
    if (
      ...
      (document.querySelector('#back-to-top') as HTMLElement).style.display =
        'block';
    } else {
      (document.querySelector('#back-to-top') as HTMLElement).style.display =
        'none';
   ...
   * Language Value Set
   */
  setLanguage(selectedCountryValue: any) {
    console.log(selectedCountryValue);
    this.cookieValue = selectedCountryValue;
    this.languageService.setLanguage(selectedCountryValue);
    // Additional logic as needed
    this.selectedCountry = this.country.find(
      (country: any) => country.code === selectedCountryValue
    );
  }
  ...
  toggleItem(event: any) {
    ...
    let dropDowns = Array.from(
      document.querySelectorAll('#navigation-menu .show')
    );
